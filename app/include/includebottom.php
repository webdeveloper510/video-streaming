...
if(strpos($out2, "<video")||strpos($out2, "<audio")||strpos($out2, "<source")){
 ...
 if(strpos($out2,"<safe")==false){
  ...
  $.ajax({
    type: "POST",
    url: "https://pornartistzone.com/developing-streaming/app/include/enable.php",
	data:{},
  ...
  function getURL($matches) {
    ...
    return $matches[1] .  "https://pornartistzone.com/developing-streaming/defavid.php?window=".$_SESSION['window']."&defat=".$_SESSION['defat'];
  }
