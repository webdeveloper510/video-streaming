...
<section class=" support1">
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        class="row"> <?php $__currentLoopData = $social_audio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <div class="col-md-12"> <div
        class="row"> <div class="col-md-8"> <div class="delete1"> <h3>
        <?php echo e($info->nickname); ?></h3> <div class="text-right artistname"> <button class="btn
        btn-outline-succes" type="button">Delete</button> </div> </div> <div
        class="post"> <h3>Description for the Post :</h3> <p><?php echo e($info->description); ?></p>
        ...
        src="<?php echo e(url('storage/app/public/audio/'.$info->media)); ?>" type="audio/mp3"> Your
        ...
        Instagram <?php echo e($info->username); ?></h5> <br> <h5> Twitter <?php echo e($info->username); ?></h5>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\video-streaming\resources\views/artists/support1.blade.php ENDPATH**/ ?>