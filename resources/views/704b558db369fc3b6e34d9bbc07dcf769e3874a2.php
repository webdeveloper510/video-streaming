            ...
            <div class="row justify-content-start mt-4">
               <div class="col">
                  <div class="form-check">
                     <label>   <?php echo e(Form::checkbox('terms','value',false,['class'=>'checkbox','placeholder'=>''])); ?> I have carefully read and accept <a class="text-white" style="border-bottom-color: initial;
