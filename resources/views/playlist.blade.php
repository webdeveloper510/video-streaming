                   ...
                   <label class="container1">{{$cat->category}} 
                        ...
                        <div class="dropdown12">
                           <h4 >Duration</h4>
                            <label class="container1">Shortest  
                             {{Form::checkbox('duration[]','shortest')}}
                            <span class="checkmark"></span>
                            </label>
                            <label class="container1">Longest 
                           {{Form::checkbox('duration[]','longest')}}
                            <span class="checkmark"></span>
                          </label>
                    ...
                    <div id="menu1" class="tab-pane fade">
                      ...
                      {{Form::token()}}
                            @foreach($category as $cat)
                            @if($cat->type=='audio')
                   <label class="container1">{{$cat->category}}  <input type="checkbox" name="checkbox[]" id="35" value="{{$cat->category}}">
                            <span class="checkmark"></span>
                            </label>
                             @endif
                            @endforeach
