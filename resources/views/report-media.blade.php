      ...
      <table class="table ">
         ...
         <tbody>
            ...
            <tr>
               ...
               <button class="btn btn-success" type="button" onClick="statusUpdate('identify_artist',1)">Confirm</button>
                     <button class="btn btn-danger" type="button" onClick="statusUpdate('identify_artist',-1)">Deny</button></td>
               <td class="text-center">
               <h5>{{$signedProfile->artist_profile ? $signedProfile->artist_profile : ''}} </h5>
               <button class="btn btn-success" type="button" onClick="statusUpdate('agreement',1)">Confirm</button>
                     <button class="btn btn-danger" type="button" onClick="statusUpdate('agreement',0)">Deny</button>
               </td>
