      ...
      <table class="table ">
         ...
         <tbody>
            ...
            <tr>
               ...
               <button class="btn btn-success agreement" style="{{$signedProfile->agreement ? 'display:block' : 'display:none'}}" type="button" onClick="statusUpdate(this,'agreement',1,{{$signedProfile->aid}})">Confirm</button>
                <button class="btn btn-danger agreement" type="button" style="{{$signedProfile->agreement ? 'display:block' : 'display:none'}}" onClick="statusUpdate(this,'agreement',-1,{{$signedProfile->aid}})">Deny</button></td>
               <td class="text-center">
               <h5>{{$signedProfile->artist_profile ? $signedProfile->artist_profile : ''}} </h5>
               <button class="btn btn-success identify_artist" type="button" style="{{$signedProfile->artist_profile ? 'display:block' : 'display:none'}}"onClick="statusUpdate(this,'identify_artist',1,{{$signedProfile->artistid}})">Confirm</button>
                     <button class="btn btn-danger identify_artist" type="button" style="{{$signedProfile->artist_profile ? 'display:block' : 'display:none'}}"onClick="statusUpdate(this,'identify_artist',-1,{{$signedProfile->artistid}})">Deny</button>
               </td>
