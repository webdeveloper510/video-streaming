    ...
    <table style="background-color: #fff;text-align: center;">
        <thead>
         ...
         <tbody>
             ...
             <tr>
                 <td> 
                     <a href="<?php echo e(url('/notify/'.base64_encode($id))); ?>"><button type="button" style="margin-top: 12px;
                     color: #fff;
                     padding: 7px;
...
</html><?php /**PATH /home/personalattentio/public_html/developing-streaming/resources/views/notify.blade.php ENDPATH**/ ?>