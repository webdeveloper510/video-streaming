...
<div class="row">
  ...
  <div class="col">
      <h3>Price</h3>
      <p><?php echo e($offerdata->price); ?><b style="font-family: 'Alfa Slab One', cursive;font-weight: 400;">PAZ</b>/minute</p>
  </div>
  <div class="col">
      <h3>Quality</h3>
...
<?php echo $__env->make('artists.dashboard_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video-streaming\resources\views/artists/offerpage.blade.php ENDPATH**/ ?>