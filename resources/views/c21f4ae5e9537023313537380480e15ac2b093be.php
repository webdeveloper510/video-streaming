...
.header img {
 ...
 <img src="<?php echo e(asset('images/logos/good_quality_logo.png')); ?>" width="60%" alt="CoolBrand">
      ...
      <h3 style="font-family: 'Allerta Stencil', sans-serif;font-weight: 400; color:white; text-align:center; padding:20px 0px;"> THE ART OF PORN IS FINALLY VALUED </h3>
       <div class=" row my-4">
  ...
  <div class="container my-4">
   ...
   <div class="row">
         <?php $__empty_1 = true; $__currentLoopData = $popularAudios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              ...
              <img  width="100%" src="<?php echo e($audio->audio_pic ? url('storage/app/public/uploads/'.$audio->audio_pic): 'https://pornartistzone.com/developing-streaming/public/images/logos/voice.jpg'); ?>">
              <audio  controlsList="nodownload" id="audio_<?php echo e($audio->id); ?>" disablePictureInPicture>
          ...
          <script>
           var audio;
            var id;
              ...
              seconds_to_min_sec(audio[0].duration,"#audio_dur"+"<?php echo e($audio->id); ?>","<?php echo e($audio->id); ?>");
            }, 2000);
          </script>
          <?php endif; ?>
              <?php endif; ?>
