...
<section class="background1">
    <div class="container mt-5">
      ...
      <div class="row justify-content-center">
        ...
        <?php endif; ?>
          <?php echo Form::open(['action' => 'AuthController@artistPost', 'method' => 'post']); ?>
          ...
          <p class="mt-2 text-white">Already have an account yet ?</p>
              <a href="<?php echo e(URL::to('artistLogin')); ?>" class="ffff text-white"> <i>Login Now</i> </a>
        </div>
      </div>
    </div>
  </section>

<?php echo $__env->make('layout.cdn', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/personalattentio/public_html/video-streaming/resources/views/artistRegister.blade.php ENDPATH**/ ?>