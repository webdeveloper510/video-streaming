  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 col-lg-8">
            <video width="100%" height="100%" poster="<?php echo e(url('storage/app/public/uploads/'.$details->audio_pic)); ?>" Controls controlsList="nodownload" disablePictureInPicture>
