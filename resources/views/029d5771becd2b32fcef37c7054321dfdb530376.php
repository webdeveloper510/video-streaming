    ...
    <div class="container">
        <div class="overlay1">
            ...
            <div class="container profile">
                ...
                <!---------------------- second Step Form-------------------->
                <!-- <div class="row align-items-center text-white"> <div class="col-md-6 pt-3">
                <?php echo e(Form::label('Gender', 'Gender')); ?> <br> <?php echo e(Form::radio('gender', 'male',
                false,['class'=>'rad_But'])); ?>Male&nbsp;&nbsp; <?php echo e(Form::radio('gender',
                'female',false,['class'=>'rad_But'])); ?>Female&nbsp;&nbsp; <?php echo e(Form::radio('gender',
                'trans',false,['class'=>'rad_But'])); ?>Trans <?php if(session('errors')): ?> <div
                class="alert alert-danger"> <?php echo $errors->first('gender') ?> </div> <?php endif; ?>
                </div> <div class="col-md-6 pt-3"> <?php echo e(Form::label('sexology', 'Sexology')); ?>

                <?php echo e(Form::select('sexology', ['Hetero' => 'Hetero', 'Homo' =>
                'Homo','Bisexual'=>'Bisexual'], null, ['class'=>'form-control','placeholder' =>
                'Choose','required'])); ?> <?php if(session('errors')): ?> <div class="alert alert-danger">
                <?php echo $errors->first('sexology') ?> </div> <?php endif; ?> </div> <div
                class="col-md-6 pt-3"> <?php echo e(Form::label('Body', 'Body')); ?> <?php echo e(Form::select('weight',
                ['Thin' => 'Thin', 'Normal' =>
                ...
                $errors->first('weight') ?> </div> <?php endif; ?> </div> <div class="col-md-6 pt-3">
                <?php echo e(Form::label('Height', 'Height')); ?> <?php echo e(Form::select('height', ['<140cm' =>
                '<140cm', '140-160cm' =>
                '140-160cm','160-180cm'=>'160-180cm','180cm<'=>'180cm<'], null,
                ['class'=>'form-control','placeholder' => 'Choose','required'])); ?>

                <?php if(session('errors')): ?> <div class="alert alert-danger"> <?php echo
                $errors->first('height') ?> </div> <?php endif; ?> </div> <div class="col-md-6 pt-3">
                <?php echo e(Form::label('Hair Color', 'Hair Color')); ?> <?php echo e(Form::select('haircolor', ['Brown'
                ...
                'Choose','required'])); ?> <?php if(session('errors')): ?> <div class="alert alert-danger">
                <?php echo $errors->first('haircolor') ?> </div> <?php endif; ?> </div> <div
                class="col-md-6 pt-3"> <?php echo e(Form::label('Hair length', 'Hair length')); ?>
                ...
                <?php if(session('errors')): ?> <div class="alert alert-danger"> <?php echo
                $errors->first('hairlength') ?> </div> <?php endif; ?> </div> <div class="col-md-6 pt-3">
                ...
                'Choose','required'])); ?> <?php if(session('errors')): ?> <div class="alert alert-danger">
                <?php echo $errors->first('eyecolor') ?> </div> <?php endif; ?> </div> <div
                class="col-md-6 pt-3"> <?php echo e(Form::label('privy part', 'Privy Part')); ?>

                <?php echo e(Form::select('privy', ['Shaved' => 'Shaved', 'Unshaved' => 'Unshaved'], null,
                [ 'class'=>'form-control','placeholder' => 'Choose','required'])); ?>

                <?php if(session('errors')): ?> <div class="alert alert-danger"> <?php echo
                $errors->first('privy') ?> </div> <?php endif; ?> </div> <div class="col-md-6 pt-3 hide"
                > <?php echo e(Form::label('tits Size', 'Tits Size')); ?> <?php echo e(Form::select('titssize', ['Small'
                => 'Small', 'Normal' => 'Normal','Big'=>'Big'], null,
                ['class'=>'form-control','placeholder' => 'Choose'])); ?> <?php if(session('errors')): ?>
                <div class="alert alert-danger"> <?php echo $errors->first('titssize') ?> </div>
                <?php endif; ?> </div> <div class="col-md-6 pt-3 hide"> <?php echo e(Form::label('Ass Size', 'Ass
                Size')); ?> <?php echo e(Form::select('ass', ['Normal' => 'Normal', 'Small' =>
                'Small','Big'=>'Big'], null, ['class'=>'form-control','placeholder' =>
                'Choose'])); ?> <?php if(session('errors')): ?> <div class="alert alert-danger"> <?php echo
                $errors->first('ass') ?> </div> <?php endif; ?> </div> <div class="col-md-12 pt-3">
                ...
                <?php if(session('errors')): ?> <div class="alert alert-danger"> <?php echo
                $errors->first('aboutme') ?> </div> <?php endif; ?> </div> <!-- <div class="col-md-6 pt-4
                "> <?php echo e(Form::label('Choose Profilepicture', 'Choose
