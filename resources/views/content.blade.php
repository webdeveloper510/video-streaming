    ...
    <div class="container">
        <div class="overlay1">
            ...
            <div class="container profile">
                ...
                {{Form::label('Gender', 'Gender')}} <br> {{Form::radio('gender', 'male',
                false,['class'=>'rad_But'])}}Male&nbsp;&nbsp; {{Form::radio('gender',
                'female',false,['class'=>'rad_But'])}}Female&nbsp;&nbsp; {{Form::radio('gender',
                'trans',false,['class'=>'rad_But'])}}Trans @if(session('errors')) <div
                class="alert alert-danger"> <?php echo $errors->first('gender') ?> </div> @endif
                </div> <div class="col-md-6 pt-3"> {{Form::label('sexology', 'Sexology')}}
                {{Form::select('sexology', ['Hetero' => 'Hetero', 'Homo' =>
                'Homo','Bisexual'=>'Bisexual'], null, ['class'=>'form-control','placeholder' =>
                'Choose','required'])}} @if(session('errors')) <div class="alert alert-danger">
                <?php echo $errors->first('sexology') ?> </div> @endif </div> <div
                class="col-md-6 pt-3"> {{Form::label('Body', 'Body')}} {{Form::select('weight',
                ['Thin' => 'Thin', 'Normal' =>
                ...
                $errors->first('weight') ?> </div> @endif </div> <div class="col-md-6 pt-3">
                {{Form::label('Height', 'Height')}} {{Form::select('height', ['<140cm' =>
                '<140cm', '140-160cm' =>
                '140-160cm','160-180cm'=>'160-180cm','180cm<'=>'180cm<'], null,
                ['class'=>'form-control','placeholder' => 'Choose','required'])}}
                @if(session('errors')) <div class="alert alert-danger"> <?php echo
                $errors->first('height') ?> </div> @endif </div> <div class="col-md-6 pt-3">
                {{Form::label('Hair Color', 'Hair Color')}} {{Form::select('haircolor', ['Brown'
                ...
                'Choose','required'])}} @if(session('errors')) <div class="alert alert-danger">
                <?php echo $errors->first('haircolor') ?> </div> @endif </div> <div
                class="col-md-6 pt-3"> {{Form::label('Hair length', 'Hair length')}}
                {{Form::select('hairlength', ['Very short' => 'Very short', 'Short' =>
                'Short','Long'=>'Long','Very Long'=>'Very Long'], null,
                ['class'=>'form-control','placeholder' => 'Choose','required'])}}
                @if(session('errors')) <div class="alert alert-danger"> <?php echo
                $errors->first('hairlength') ?> </div> @endif </div> <div class="col-md-6 pt-3">
                ...
                'Choose','required'])}} @if(session('errors')) <div class="alert alert-danger">
                <?php echo $errors->first('eyecolor') ?> </div> @endif </div> <div
                class="col-md-6 pt-3"> {{Form::label('privy part', 'Privy Part')}}
                {{Form::select('privy', ['Shaved' => 'Shaved', 'Unshaved' => 'Unshaved'], null,
                [ 'class'=>'form-control','placeholder' => 'Choose','required'])}}
                @if(session('errors')) <div class="alert alert-danger"> <?php echo
                $errors->first('privy') ?> </div> @endif </div> <div class="col-md-6 pt-3 hide"
                > {{Form::label('tits Size', 'Tits Size')}} {{Form::select('titssize', ['Small'
                => 'Small', 'Normal' => 'Normal','Big'=>'Big'], null,
                ['class'=>'form-control','placeholder' => 'Choose'])}} @if(session('errors'))
                <div class="alert alert-danger"> <?php echo $errors->first('titssize') ?> </div>
                @endif </div> <div class="col-md-6 pt-3 hide"> {{Form::label('Ass Size', 'Ass
                Size')}} {{Form::select('ass', ['Normal' => 'Normal', 'Small' =>
                'Small','Big'=>'Big'], null, ['class'=>'form-control','placeholder' =>
                'Choose'])}} @if(session('errors')) <div class="alert alert-danger"> <?php echo
                $errors->first('ass') ?> </div> @endif </div> <div class="col-md-12 pt-3">
                ...
                @if(session('errors')) <div class="alert alert-danger"> <?php echo
                $errors->first('aboutme') ?> </div> @endif </div> <!-- <div class="col-md-6 pt-4
                "> {{Form::label('Choose Profilepicture', 'Choose
