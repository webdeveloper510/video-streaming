      ...
      <h3 style="font-size: 32px;font-family: 'Allerta Stencil', sans-serif;font-weight: 400; color:white; text-align:center; padding:20px 0px;"> THE ART OF PORN IS FINALLY VALUED </h3>
       <div class="container row my-4">
          <div class="col-md-6 mb-3 text-center">
             <a href="{{url('/register')}}"><button type="button" class="btn btn-success free form-control">Join Free</button></a>
          </div>
          <div class="col-md-6 text-center">
             <a href="{{url('/login')}}"><button type="button" class="btn btn-primary  form-control freelog">Login</button></a>
          </div>
       </div>
 </div>
     <div class="row">
  ...
  <div class="coner my-4">
    ...
    <div id="recently_search" class="row">
      ...
      @forelse ($recently as $recnt)
          ...
          <video class="hoverVideo" poster="{{url('storage/app/public/uploads/'.$recnt->audio_pic) }}" id="recently_{{$recnt->id}}" width="100%" height="275px" controls="false" allowfullscreen controlsList="nodownload" disablePictureInPicture>
  ...
  var id;
          ...
          @forelse ($popular as $pop)
            ...
            <div class="col-md-4 hover">
                ...
                <video class="hoverVideo" poster="{{url('storage/app/public/uploads/'.$pop->audio_pic) }}" id="video_{{$pop->id}}" width="100%"  height="275px" controls="false" allowfullscreen controlsList="nodownload" disablePictureInPicture>
  ...
  <div class="container my-4">
   ...
   <div class="row">
    ...
    <a href="{{url('artistoffers/'.$offer->id)}}">
      <div class="card">
      <video width="100%"  height="275px" poster="{{url('storage/app/public/uploads/'.$offer->audio_pic) }}"  controlsList="nodownload" disablePictureInPicture>
	  ...
	  <div class="carad-body">
        ...
        <tr>
          ...
          <td>{{$offer->type=='video'? 'Video/mp4' :'Audio/mp3' }}</td>
            ...
            <tr>
            	<th>Price</th>
            	<td> <span style="color:gold;">{{$offer->price}}  <b style="font-family: 'Alfa Slab One', cursive;font-weight: 400;">PAZ</b></span>/Minute </td>
              </tr>
	      </table>
	         </div>
   </div>
