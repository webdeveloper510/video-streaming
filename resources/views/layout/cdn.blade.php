...
<link rel="stylesheet" href="{{asset('design/font-awesome.min.css')}}" />
<!-- responsive css -->
<link rel="stylesheet" href="{{asset('design/responsive.css')}}" />
<link rel="stylesheet" href="{{asset('design/detailpage.css')}}" />
<!-- colors css -->
<link rel="stylesheet" href="{{asset('design/colors1.css')}}" />
<!-- custom css -->
<link rel="stylesheet" href="{{asset('design/custom.css')}}" />
<!-- wow Animation css -->
<link rel="stylesheet" href="{{asset('design/animate.css')}}" />
...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
 <script src="https://www.google.com/recaptcha/api.js?render=6LdZSN4ZAAAAAH0IvubFmsHQqh3HUg4A6sYNzLNm"></script>
